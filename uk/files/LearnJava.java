...
public class LearnJava {
    ...
    public static void main (String[] args) {
        ...
        */
        ...
        // Перші фігурні дужки створюють анонімний внутрішній клас, а другі —
        // блок ініціалізації екземпляра. Однак це вважається антипаттерном: 
        // створюється новий клас для кожного випадку, що збільшує витрати 
        // пам'яті (Metaspace) і може спричинити витік пам'яті. 
        // Для Java 9+ використовуйте Set.of().
