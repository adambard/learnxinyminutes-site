...
// Ключове слово "let" дозволяє оголошувати змінні в лексичній області видимості,
// на відміну від області видимості функції, як це робить ключове слово var.
let name = "Біллі";

// Змінним, оголошеним через let, можна присвоювати нові значення.
name = "Вільям";

// Ключове слово "const" дозволяє оголошувати змінну в лексичній області видимості,
// як і let, але після присвоєння значення його не можна змінити.

const pi = 3.14;

pi = 4.13; // Так робити не можна.

// В ES6 з’явився новий синтаксис для функцій, відомий як "лямбда-синтаксис".
// Він дозволяє визначати функції в лексичній області видимості,
// так само як змінні, оголошені через const і let.
...
// "Еквівалент" цієї функції у традиційному синтаксисі виглядав би так:

function isEven(number) {
    return number % 2 === 0;
};

// Я використав слово "еквівалент" у лапках, тому що функцію,
// визначену через лямбда-синтаксис, не можна викликати до її оголошення.
// Нижче наведено приклад неправильного використання:

add(1, 8); // Помилка ReferenceError: add is not defined
